...
export function buildSummarizationPrompt(options: SummarizationOptions): string {
  ...
  return (
    'You are an expert academic note-taker and assistant. Analyze the following transcript and generate structured, comprehensive notes in JSON format.\n\n' +
    languageInstruction +
    '\n\nFocus on: ' +
    focusAreas +
    '\nDetail level: ' +
